...
cargaData=()=>{
  ...
  const otrosIngresos=Tutorial.create({name:"4.-Otros ingresos y Otras salidass" , descrip:"sumar o restar cajas o unidades al stock q ya tenemos, de manera rapida y sin muchos requisistos" ,
  ...
  const cuadre=Tutorial.create({name:"Cuadre de caja y Reguistro de ventas" , descrip:"poder realizar el cuadre de caja con las herramientas del sistema farmasis" ,
